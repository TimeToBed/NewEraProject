        ...
        <div class="w-full flex basis-auto items-center">
          ...
          <div class="relative inline-block pt-1 ml-4">
            <div class="text-white">
              <div class="flex items-center">
                <ChevronDoubleUpIcon  class="cursor-pointer h-4 w-4" @click="handleArrowClick"/>
              </div>
            </div>
          </div>
        </div>
...
import { MenuIcon, MenuAlt1Icon, SearchIcon, SearchCircleIcon, ChevronDoubleUpIcon , ChevronDoubleDownIcon} from '@heroicons/vue/outline'
